...
class EmployeeController extends Controller
{
    ...
    {
        // WARNING NEED TO MODIFY HANDLE DIFFERENT STRING KEYWORD OF DEPARTMENT
        return Inertia::render('EmployeeInfoRecords', [
            'employees' => User::with(['user_skills', 'violations', 'supervisor', 'team'])->where('department', '<>', 'SOFTWARE')->get()
        ]);
    }
    ...
    {
        $employees = User::with(['team'])->where('department', '<>', 'SOFTWARE')
